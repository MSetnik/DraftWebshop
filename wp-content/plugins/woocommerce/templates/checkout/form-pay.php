	...
	<table class="shop_table">
		<thead>
			<tr>
				...
				<th class="product-total"><?php esc_html_e( 'Ukupno', 'woocommerce' ); ?></th>
			</tr>
		</thead>
		<tbody>
		...
		<?php if ( $order->needs_payment() ) : ?>
			<ul class="wc_payment_methods payment_methods methods">
				...
				if ( ! empty( $available_gateways ) ) {
					...
					echo '<li class="woocommerce-notice woocommerce-notice--info woocommerce-info">' . apply_filters( 'woocommerce_no_available_payment_methods_message', esc_html__( 'Nažalost nema dostupnih metoda plaćanja za Vašu lokaciju.', 'woocommerce' ) ) . '</li>'; // @codingStandardsIgnoreLine
				}
				?>
			</ul>
		<?php endif; ?>
